...
#define NL nb_line
#define NW(str, c) (nb_word(str, c, 0, 0))
#define SL size_line
#define SW size_word
...
int   nb_word(char *str, char c, int i, int n);/*(.., 0, 0)*/ /* 1 2 */
