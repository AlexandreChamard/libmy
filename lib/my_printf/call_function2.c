...
** Last update Sun Feb  5 16:50:36 2017 Alexandre Chamard-bois
*/
...
char            *call_put_unsigned_nbr(va_list ap, char *str)
{
	...
	nb = va_arg(ap, int);
	my_putnbr_base(str + i, nb, "0123456789");
...
char				    *call_put_o_nbr(va_list ap, char *str)
{
	...
	my_putnbr_base(str + i, nb, "01234567");
	str = my_printrevstr(str, i);
	return (str);
}
